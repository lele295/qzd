...
<head>
    ...
    <style>
        * {margin: 0;padding: 0; list-style:none; border:0px}
        ...
        .error404{width:100%; height:100%; position:fixed; top:45px; background:url({{asset('/images/404_bg.png')}}) no-repeat left top; background-size:100%; text-align:center;}
        ...
        .error505_img{width:80%;margin:10px 0 20px 0}
...
<div class="content">
    <div class="error404">
        <img src="{{asset('/images/505_img.png')}}" class="error505_img">
        <p class="error505_p"><span class="error505_p_span">系统维护中...</span><br/>
        </p>
    </div>
</div>
