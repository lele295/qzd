 ...
 */
    ...
    this.selectorPIdStr = 'familyCity-level-one'+ this.config.suffix;
    this.selectorCIdstr = 'familyCity-level-two' + this.config.suffix;
    this.init();
}

familyCity.prototype.init = function(){
    (function(a){
        a.cityMap =
 ...
 * 添加监听
 */
familyCity.prototype.addListener = function(){
    (function(a){
...
$(function(){
    new familyCity({
        selectorStr:'#family_addr1',
        callback:function(val,name){
            $('#family_addr1').val(val);
        }
    });
